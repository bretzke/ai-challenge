        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Nosso assistente de IA permite que você faça perguntas em
              linguagem natural sobre nossos produtos e pedidos. A IA interpreta
              sua pergunta e busca as informações no banco de dados, retornando
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              ...
              utilizados e em perfeito estado. Entre em contato conosco através
              do assistente de IA ou pelo nosso suporte.
            </p>
          </div>
        </div>
