    ...
    <div className={`prose prose-sm max-w-none ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          ul: ({ node, ...props }) => (
            <ul className="list-disc list-inside mb-4 space-y-1 ml-4 text-gray-700" {...props} />
          ),
          ol: ({ node, ...props }) => (
            <ol className="list-decimal list-inside mb-4 space-y-1 ml-4 text-gray-700" {...props} />
          ),
          li: ({ node, ...props }) => (
          ...
          th: ({ node, ...props }) => (
            <th className="border border-gray-300 px-4 py-2 text-left font-semibold text-slate-800" {...props} />
          ),
          td: ({ node, ...props }) => (
